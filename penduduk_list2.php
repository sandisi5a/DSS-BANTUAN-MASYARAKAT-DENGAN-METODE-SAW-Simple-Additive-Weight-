...
<div id="wrapper">
					...
					<li class="active"> >> Rekomendasi Warga</li>
				</ol>
<h3>Rekomendasi Warga yang layak diberikan bantuan Dana</h3>
		...
		<?php while ($baris=mysqli_fetch_array($qry)) {
									...
									$update=mysqli_query($conn, "update tbwarga set nilai='$total' where idpenduduk='$idpenduduk'  ");
		...
		<h4>KRITERIA BERDASARKAN : <b><?php echo $baris4['nama_kriteria']; ?> </h4>
								...
								<tr>
									...
									<td><?php echo $baris3['nilai']; ?></td>
									<td>
										
										<a href="#" onclick="return confirm('Pilih');"><button type="button" class="btn btn-success">Pilih</button></a>
									</td>
									<?php } ?>
								</tr>
