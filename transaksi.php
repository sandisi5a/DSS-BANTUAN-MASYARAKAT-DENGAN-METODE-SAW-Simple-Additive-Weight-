            ...
            <div class="container">
                ...
                switch($p){
                    default:
                        echo "<table class='table table-bordered'>
                            <tr>
                                ...
                                $query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from penjualan");
                    ...
                    case "tambah":
                        ...
                        $auto=mysqli_query($GLOBALS["___mysqli_ston"], "select * from penjualan order by nonota desc limit 1");
                    ...
                    case "detail":
                        ...
                        $nota=$_GET['nota'];
                        $query=mysqli_query($GLOBALS["___mysqli_ston"], "select penjualan.nonota,detailpenjualan.kode,tblbarang.nama,
                        ...
                        $nomor=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from penjualan where nonota='$nota'"));
                        echo "<div class='navbar-form pull-right'>
